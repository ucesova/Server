...
app.get('/getPOI', function (req,res) {
	...
	// note that query needs to be a single string with no line breaks so built it up bit by bit
		...
		querystring = querystring + "row_to_json((SELECT l FROM (SELECT question, choice1, choice2, choice3, choice4, correct_choice) As l )) As properties";
...
app.post('/uploadData',function(req,res){
	...
	pool.connect(function(err,client,done) {
		...
		var querystring = "INSERT into questions (question, choice1, choice2, choice3, choice4, correct_choice, geom) values ('";
		querystring = querystring + req.body.question + "','" + req.body.choice1 + "','" + req.body.choice2 + "','";
		querystring = querystring + req.body.choice3 + "','" + req.body.choice4 + "','" + req.body.correct_choice+"',"+geometrystring + "))";
